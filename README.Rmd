...
The maximum entropy algorithm utilized in this package is provided by the MaxEnt java program (Phillips et al., 2006). You must have a Java Runtime Environment installed on your computer for this program (and the maxentmodelselectr package) to function properly. Java Runtime Environment can be downloaded and installed from \url{java.com/download}.

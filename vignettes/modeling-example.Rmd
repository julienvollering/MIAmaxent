...
```
The explanatory variables included in this model are: pr_bygall, terslpps15, pca1, lcucor1, and geoberg.
...
```{r, fig.width=5, fig.height=5, fig.align='center', fig.cap="Model predictions in probability ratio output (PRO) across the study area"}
library(raster)

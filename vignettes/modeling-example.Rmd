...
```{r, fig.width=5, fig.height=5, fig.align='center', fig.cap="Presence-only occurrence across the study area"}
library(raster)
...
```{r, fig.show='hold', fig.width=5, fig.height=5, fig.align='center', fig.cap="Presence (red) and absence (blue) test data plotted over model predictions"}

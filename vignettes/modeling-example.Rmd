...
```{r, fig.show='hold', fig.width=5, fig.height=5}
grasslandAUC <- testAUC(grasslandPA, transformation = system.file("extdata", "transformations.Rdata", package = "maxentmodelselectr"), model = system.file("extdata", "1.lambdas", package = "maxentmodelselectr"))
grasslandAUC
```

...
As a measure of variable contribution, we can calculate the Fraction of Total Variation Accounted for (RVA) by each variable (Halvorsen et al., 2015). Here with our chosen model:
...
legend('top', c('presence', 'absence'), col = c('red', 'blue'), pch = c(20, 20))
```

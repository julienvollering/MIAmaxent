...
#'   number of observations in the interval ("n"), mean EV value of the points
#'   in the interval ("intEV"), mean RV value of the observations in the
#'   interval ("intRV"), and local regression predicted intRV ("loess"). For
#'   categorical variables, only the level name ("level"), the number of
